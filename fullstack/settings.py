...
SECRET_KEY = 'tg-68wtkjutfu)j4xct+lx%prs*=^(hll)m8qzw26hyhvka78v'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'fullstack/static')
]
...
EMAIL_HOST_PASSWORD = 'abanyarwanda2020'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
